...
3. Enable USB Debugging on your Quest, connect it and allow access in VR (this is a bit more involved but there are instructions for this online). If you're using SideQuest, they already made you do this step. As long as SideQuest can see your device you should be good to go.
